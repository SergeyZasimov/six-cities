...
export const getOffers = (state: State) =>
  state[DomainNameSpace.Data].offers.filter(
    (offer) =>
      offer.city.name === state[DomainNameSpace.Location].currentLocation,
  );

export const getCommentList = (state: State) =>
  state[DomainNameSpace.Data].commentList;

export const getRoom = (state: State) => state[DomainNameSpace.Data].room;
...
export const getFavoriteOffers = (state: State) =>
  state[DomainNameSpace.Data].favoriteOffers;
